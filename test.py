...
node_df['cat1'] = (node_df['LABEL']>0).astype(int)
node_df['cat2'] = (node_df['LABEL']==0).astype(int)
...
#             columns=['emb1','emb2'])
embed_norm = orchestrator._load_normalized_embed().iloc[:,:2]
...
print(f"synth rows = {synth_nodes.shape[0]}")
